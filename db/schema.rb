...
ActiveRecord::Schema[7.2].define(version: 2025_05_25_000005) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "first_name"
    t.string "last_name"
    t.boolean "consultant_role"
    t.boolean "acting_as_admin", default: false
  ...
  add_foreign_key "meetings", "users", column: "client_id"
  add_foreign_key "meetings", "users", column: "consultant_id"
end
